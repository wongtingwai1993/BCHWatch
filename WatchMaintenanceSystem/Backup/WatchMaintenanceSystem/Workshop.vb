...
Public Class Workshop
    ...
    Private Sub btnSearch_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSearch.Click
        ...
        Try
            ...
            Else
                query += "where receiptId!=0 and invoiceStatus='O' "
            End If
    ...
    Private Sub dgvInfo_CellMouseDoubleClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.DataGridViewCellMouseEventArgs) Handles dgvInfo.CellMouseDoubleClick
        If e.RowIndex >= 0 Then
            ...
            Dim wrkshpDetail As New WorkshopDetail
            wrkshpDetail.GetData(row.Cells("receiptId").Value.ToString)
            wrkshpDetail.ShowDialog()
            Me.Close()

        End If
    End Sub

    Private Sub Workshop_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
